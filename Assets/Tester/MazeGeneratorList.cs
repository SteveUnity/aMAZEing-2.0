...
public class MazeGeneratorList : MonoBehaviour
{
    ...
    public void BackWall(int x, int z, int index)
    {
        GameObject wallBack = Instantiate(wall, maze[x, z].wall[index].transform);
